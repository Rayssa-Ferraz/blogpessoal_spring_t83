...
public class UsuarioControllerTest {
	...
	void DeveAtualizarUmUsuario() {
		...
		Usuario usuarioUpdate = TestBuilder.criarUsuario(
                usuarioCadastrado.get().getId(), "Nadia Caricatto", "nadia@email.com.br", "abc12345");
	...
	void deveListarTodosUsuarios() {
        //Given
        usuarioService.cadastrarUsuario(TestBuilder.criarUsuario(null, "Rayssa Ferraz", "rayssa_ferraz@email.com.br", "12345678"));
        usuarioService.cadastrarUsuario(TestBuilder.criarUsuario(null, "Geovana Cazali", "geo_cazali@email.com.br", "123456789"));
        
        //When
        String token = JwtHelper.obterToken(testRestTemplate, USUARIO, SENHA);
        HttpEntity<Usuario> requisicao = JwtHelper.criarRequisicaoComToken(null, token);
        ResponseEntity<Usuario[]> resposta = testRestTemplate.exchange(
	...
	@Test
	@DisplayName("05 - Deve listar usuário por id com sucesso")
	void deveListarUsuarioPorId() {
        //Given
        Usuario usuario = TestBuilder.criarUsuario(null, "Sofia de Araujo", "sofia_araujo@email.com.br", "12345678");
        Optional<Usuario> usuarioCadastrado = usuarioService.cadastrarUsuario(usuario);
